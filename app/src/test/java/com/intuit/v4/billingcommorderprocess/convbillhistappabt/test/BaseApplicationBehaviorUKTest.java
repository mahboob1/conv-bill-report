...
import com.intuit.v4.billingcommorderprocess.convbillhistappabt.TestAppUK;
...
@SpringBootTest(classes = TestAppUK.class, webEnvironment = WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@TestPropertySource(properties = {"cntrlsvc.dbName=UK"})
public class BaseApplicationBehaviorUKTest {
